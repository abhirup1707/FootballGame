...
function migratePostgres() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS ad_rewards (id SERIAL PRIMARY KEY, user_id INTEGER NOT NULL REFERENCES users(id) ON DELETE CASCADE, claimed_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP);
